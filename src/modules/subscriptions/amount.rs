    ...
    crate::modules::subscriptions::validation::ValidationModule +
{
     ...
     */
    fn get_subscription_charge_amounts_for_account(&self, subscription: &Subscription<Self::Api>, account: &ManagedAddress) -> (BigUint, BigUint) {
        ...
        (cycle_cost.clone() * total_pending_cycles, cycle_cost * affordable_cycles)
    }
}
