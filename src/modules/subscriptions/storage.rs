...
pub trait StorageModule {
    ...
    fn subscription_member_start_time(
        &self,
        id: u64,
    ...
    fn subscription_member_last_trigger_time(
        &self,
        id: u64,
        address: &ManagedAddress,
    ) -> SingleValueMapper<u64>;
    ...
    fn subscription_defined_amount_per_member(
        &self,
        id: u64,
        address: &ManagedAddress,
    ...
    fn account_subscriptions_created_list(
        &self,
        address: &ManagedAddress,
    ...
    fn account_subscriptions_membership_list(
        &self,
        address: &ManagedAddress,
    ) -> UnorderedSetMapper<u64>;
}
